import {detectOverflow, DetectOverflowOptions} from '../detectOverflow';
import {evaluate} from '../evaluate';
import {getAlignmentSides} from '../getAlignmentSides';
import {getExpandedPlacements} from '../getExpandedPlacements';
import {getOppositeAxisPlacements} from '../getOppositeAxisPlacements';
import {getOppositePlacement} from '../getOppositePlacement';
import {getSide} from '../getSide';
import {isRTL} from '../isRTL';
import type {Derivable, Middleware, Placement} from '../types';
...
export const flip = (
  ...
  options,
  fn(state) {
    const {placement, middlewareData, rects, initialPlacement, elements} =
      state;
