...
test.skip('external reference element sync', async () => {
  function App() {
    const [referenceEl, setReferenceEl] = useState<HTMLElement | null>(null);
    const {x, y, refs} = useFloating({
      elements: {
...
test.skip('external floating element sync', async () => {
  function App() {
    const [floatingEl, setFloatingEl] = useState<HTMLElement | null>(null);
    const {x, y, refs} = useFloating({
      elements: {
...
test.skip('external elements sync 2', async () => {
  function App() {
    const [referenceEl, setReferenceEl] = useState<HTMLElement | null>(null);
    const [floatingEl, setFloatingEl] = useState<HTMLElement | null>(null);
...
test.skip('floatingStyles no transform', async () => {
  function App() {
...
test.skip('floatingStyles default', async () => {
  function App() {
    const {refs, floatingStyles} = useFloating();
