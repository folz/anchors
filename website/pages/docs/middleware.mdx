...
You may notice that Anchors' core middleware are actually
...
An object containing methods to make Anchors work on the current
platform, e.g. DOM or React Native.
